...
var id = "kieranid.json";
var track ="kierantrackinfo.json";
var artist = "kieranartistinfo.json";
user[2] = new newuser(id, track, artist);
var id = "ryanid.json";
var track ="ryantrackinfo.json";
var artist = "ryanartistinfo.json";
user[3] = new newuser(id, track, artist);
